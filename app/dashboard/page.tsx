          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/15 to-transparent group-hover:via-blue-400/40 transition-colors" />
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[10px] font-semibold tracking-wider uppercase px-2 py-0.5 rounded-md bg-white/[0.04] text-slate-400 font-mono">
                      {card.tag}
                    </span>
                  </div>
                  ...
                  <div className="text-3xl font-black text-white mt-1.5 font-heading tracking-tight flex items-baseline gap-2">
                    {stats.loading ? (
                ...
                <div className="mt-4 pt-3 border-t border-white/[0.06] flex items-center justify-between text-xs text-slate-400 group-hover:text-slate-200 transition-colors">
                  <span className="text-[11px] truncate">{card.desc}</span>
                  <ArrowRight className="h-3.5 w-3.5 text-slate-500 group-hover:text-primary group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
            </motion.div>
          );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 rounded-3xl glass-panel p-6 sm:p-7 flex flex-col justify-between space-y-6">
            ...
            {quickNavLinks.map((item, idx) => {
              ...
              return (
                <Link
                  key={idx}
                  href={item.href}
                  className="p-3.5 rounded-2xl border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/[0.12] transition-all flex items-center justify-between group"
                >
          ...
          <div className="pt-4 border-t border-white/[0.06]">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-2">
              <span className="font-semibold text-slate-300">Technology Radar Distribution</span>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-2.5 text-[11px] text-slate-400 font-mono">
        ...
        <div className="lg:col-span-5 rounded-3xl glass-panel p-6 sm:p-7 flex flex-col justify-between space-y-6">
          ...
          <div className="space-y-3 font-mono text-xs">
            {/* DRF Backend */}
            <div className="p-3.5 rounded-xl border border-white/[0.06] bg-black/40 flex flex-col gap-1">
              <span className="text-[10px] uppercase tracking-wider text-slate-400 font-sans font-semibold">
                DRF Backend API Host
              </span>
              <div className="flex items-center justify-between">
                <span className="text-emerald-400 font-semibold truncate text-[11px]">{apiUrl}</span>
            ...
            <div className="p-3.5 rounded-xl border border-white/[0.06] bg-black/40 flex flex-col gap-1">
              ...
              <div className="flex items-center justify-between">
                <span className="text-blue-400 font-semibold truncate text-[11px]">{portfolioUrl}</span>
                <a href={portfolioUrl} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white">
            ...
            <div className="p-3.5 rounded-xl border border-white/[0.06] bg-black/40 flex flex-col gap-1">
              ...
              <div className="flex items-center justify-between">
                <span className="text-purple-400 font-semibold truncate text-[11px]">Neon PostgreSQL Pooler</span>
                <span className="text-[10px] text-emerald-400">SSL require</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-white/[0.06] flex items-center justify-between gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 py-2.5 px-3 rounded-xl border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.07] text-xs font-semibold text-slate-200 text-center transition-colors flex items-center justify-center gap-1.5"
            >
